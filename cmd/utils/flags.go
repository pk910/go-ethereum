...
var (
	...
	EphemeryFlag = &cli.BoolFlag{
		Name:     "ephemery",
		Usage:    "Ephemery network: pre-configured ephemeral proof-of-stake test network",
		Category: flags.EthCategory,
	}
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	CheckExclusive(ctx, MainnetFlag, DeveloperFlag, RopstenFlag, RinkebyFlag, GoerliFlag, SepoliaFlag, KilnFlag, EphemeryFlag)
